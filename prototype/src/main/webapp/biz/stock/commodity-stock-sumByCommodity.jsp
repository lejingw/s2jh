...
<div class="row search-form-default">
	<div class="col-md-12">
		<form method="get" class="form-inline form-validation form-search-init"
			data-grid-search=".grid-biz-stock-commodity-stock-sumByCommodity" action="#">
...
<div class="row">
	<div class="col-md-12">
		<table class="grid-biz-stock-commodity-stock-sumByCommodity"></table>
	</div>
</div>
<script src="${base}/biz/stock/commodity-stock-sumByCommodity.js" />
