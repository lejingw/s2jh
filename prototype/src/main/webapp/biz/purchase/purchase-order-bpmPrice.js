$(function() {
    ...
    $(".form-edit-purchase-order").data("formOptions", {
        updateTotalAmount : function() {
            var $form = $(this);
            var $grid = $form.find(".grid-biz-purchase-purchase-order-bpmPrice");
            var userData = {
    ...
    $(".grid-biz-purchase-purchase-order-bpmPrice").data("gridOptions", {
